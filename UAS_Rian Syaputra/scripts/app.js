...
$('#btValider').click(function() {
    ...
    $.ajax({
        ...
        success: function() {
            swal('Data Berhasil Disimpan', 'Kendaraan', 'success')
                .then(() => {
                    location.reload();
                });
        }
...
$('#btUpdateClient').click(function() {
    ...
    $.ajax({
        ...
        success: function() {
            swal('Edit Kendaraan', 'Pembaruan berhasil diselesaikan', 'berhasil')
                .then(() => {
                    location.reload();
                });
        }
...
function deleteClient(id) {
    swal({
            ...
            text: "Anda akan menghapus Kendaraan !",
            icon: "warning",
        ...
        .then((willCancel) => {
            if (willCancel) {
                $.ajax({
                    ...
                    success: function() {
                        swal('Dihapus !', 'Akun Kendaraan berhasil dihapus', 'berhasil')
                            .then(() => {
                                location.reload();
                            });
                    },
                ...
                swal("Akun Kendaraan belum dihapus");
            }
        });
}